...
/**
 * rev_str - Turns a string around
 * @s: the string to turn around
 *
 * Return: Nothing.
 */
void rev_str(char *s)
...
/**
 * blen - Finds the base-number length.
 * @n: numeral
 * @base: number’s base.
...
/**
 * _itoa - translates an integer to string
 *
 * @n: numeral
 *
...
/**
 * _error - generates a string containing an error line
 * @errn: number corresponds to error type.
 * @shpack: structure with shell information
 * @exnum: The shell’s exit value should be
...
/**
 * _error2 - Additional error generation modes.
 * @errn: number relates to the error type.
 * @conc2: error portion from _error
 * @option: command line option (cmd) that
 *
