...
/**
 * _exit_cmd - shows the built in command exit
 * @shpack: this is the struct containing shell info
 *
...
/**
 * _env_cmd - it shows the built in command env
 * @shpack: indicates struct containing shell info
 *
...
/**
 * _setenv_cmd - it shows built in command setenv
 * @shpack: indicates struct containing shell info
 *
 * Return: returns 1 if successful, -1 if fail
 */
...
/**
 * _unsetenv_cmd - shows built in command unsetenv
 * @shpack: indicates struct containing shell info
 *
 * Return: returns 1 if successful, -1 if fail
 */
...
/**
 * built_ints - this checks if the cmd is a built in
 * @shpack: indicates struct containing shell info
 *
 * Return: returns on fail 0
 */
