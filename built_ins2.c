...
/**
 * auxcd2 - the auxiliary function of cd built in
 * @shpack: indicates struct containing shell info
 * @currdir: shows the current directory
 *
 * Return: returns pointer to HOME or NULL if fail
 */
...
/**
 * auxcd - the auxiliary function of cd built in
 * @shpack: indicates struct containing shell info
 * @currdir: shows the current directory
 *
 * Return: returns Pointer to dir or NULL if fail
 */
...
/**
 * _cd_cmd - the built in command cd
 * @shpack: indicates struct containing shell info
 *
 * Return: returns 1 if succesful, -1 if fail
 */
